from app import *
from utils import retrieve_dotenv

# setup  (Python uses dotenv)
dotenv_path: str = ".env"

SOURCE_ONE_URL = retrieve_dotenv(key="SOURCE_ONE_URL", dotenv_path=dotenv_path)
SOURCE_ONE_COOKIE = retrieve_dotenv(key="SOURCE_ONE_COOKIE", dotenv_path=dotenv_path)
